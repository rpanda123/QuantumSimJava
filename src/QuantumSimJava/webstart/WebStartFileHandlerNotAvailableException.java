...
/**
 * This is an exception that is thrown whenever a web start file handler
 * is not available.
 * @author Dave Boden
 * @version 1.0
 */
...
public class WebStartFileHandlerNotAvailableException extends Exception {
	 ...
	 * @param serviceName the service name for the detail message 
    ...
    public WebStartFileHandlerNotAvailableException(String serviceName) {
        super("Running in a WebStart environment but " +
